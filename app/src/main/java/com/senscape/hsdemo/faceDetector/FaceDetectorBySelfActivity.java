...
public class FaceDetectorBySelfActivity extends HsBaseActivity implements Camera.PreviewCallback {
    ...
    private FaceDetectorBySelfThread mHsThread;
        ...
        mHolder.addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
                ...
                try {
                    ...
                    mCamera.setPreviewCallback(FaceDetectorBySelfActivity.this);
    ...
    public void onPreviewFrame(byte[] data, Camera camera) {
        if (mHsThread != null && isInit) {
            ...
            FDFrameTask myAsyncTask = new FDFrameTask(mHsThread, mDrawView);
